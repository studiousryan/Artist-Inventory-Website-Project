...
<?php 
    ...
    $query = "SELECT *, (teamInfo.goalsScored - teamInfo.goalsAgainst) AS goalsDifference FROM teamInfo WHERE 1 ORDER BY teamInfo.points DESC, goalsDifference DESC, goalsScored DESC;";
    // echo $query;
